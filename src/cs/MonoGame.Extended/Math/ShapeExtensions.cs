...
using MonoGame.Extended.Texture;
...
namespace MonoGame.Extended
{
	...
	public static class ShapeExtensions
	{
		...
		public static void DrawPolygon( this SpriteBatch spriteBatch, Vector2 offset, IReadOnlyList<Vector2> points, Color color, float thickness = 1f, float layerDepth = 0 )
		{
			...
			var texture = spriteBatch.GraphicsDevice.GetWhitePixelTexture();
		...
		{
			spriteBatch.Draw( spriteBatch.GraphicsDevice.GetWhitePixelTexture(), location, null, color, 0, Vector2.Zero, size, SpriteEffects.None, layerDepth );
		}
		...
		public static void DrawLine( this SpriteBatch spriteBatch, Vector2 point, float length, float angle, Color color, float thickness = 1f, float layerDepth = 0 )
		{
			...
			var scale = new Vector2( length, thickness );
			spriteBatch.Draw( spriteBatch.GraphicsDevice.GetWhitePixelTexture(), point, null, color, angle, origin, scale, SpriteEffects.None, layerDepth );
		}
		...
		public static void DrawPoint( this SpriteBatch spriteBatch, Vector2 position, Color color, float size = 1f, float layerDepth = 0 )
		{
			...
			spriteBatch.Draw( spriteBatch.GraphicsDevice.GetWhitePixelTexture(), position + offset, null, color, 0f, Vector2.Zero, scale, SpriteEffects.None, layerDepth );
		}
